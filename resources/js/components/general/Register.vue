        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                <img 
                    ...
                    alt="">
                <h2 class="mt-6 text-center txt-3xl font-extrabold text-gray-900">Registrate</h2>
            ...
            <form 
                ...
                <div>
                    <label 
                        :class="[errors.name ? 'text-red-700' : '']"
                        class="block mb-2 text-sm font-medium text-gray-900">Nombres y Apellidos</label>
                    <div class="relative">
                        ...
                        <input 
                            v-model="name" 
                            type="text" 
                            :class="[errors.name ? 'bg-red-50 border border-red-500 text-red-900 placeholder-red-700 ' : '']"
                ...
                <div>
                    <label 
                        :class="[errors.email ? 'text-red-700' : '']"
                    ...
                    <div class="relative">
                        ...
                        <input 
                            v-model="email" 
                            type="email" 
                            :class="[errors.email ? 'bg-red-50 border border-red-500 text-red-900 placeholder-red-700 ' : '']"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" 
                ...
                <div>
                    <label 
                        :class="[errors.password ? 'text-red-700' : '']"
                ...
                <div>
                    <label for="email-adress-icon" class="block mb-2 text-sm font-medium text-gray-900">Repita su contraseña</label>
                    <div class="relative">
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v2H2v-4l4.257-4.257A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z" clip-rule="evenodd" />
            ...
            <div
                ...
                <span class="font-medium">Felicidades</span> Se ha creado su cuenta con éxito. Dentro de unos momentos será redireccionado al login.
            </div>
        </div>
    </div>
</template>
